def bubble(array):
    for j in range(0, len(array)-1): # Este for é utilizado para que o programa sempre percorra a lista, excluindo o ultimo valor, já que ele não teria nenhum outro numero para se comparar.
